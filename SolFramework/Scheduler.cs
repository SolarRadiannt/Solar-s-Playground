...
public static class SPriority
{
	...
	public static readonly int Lowest	= -100_000;
	public static readonly int Lower	= -10_000;
	public static readonly int Low		= -1_000;
	public static readonly int High		= 1_000;
	public static readonly int Higher	= 10_000;
	public static readonly int Highest	= 100_000;
...
static class Scheduler
{
	...
	private static List<(Action<double>, int)> _physicsSystems = new();
	...
	public static void RegisterPhysicsSystem(ISystem system)
	{
		RegisterPhysicsSystem(system.Process, system.Priority);
	}
	public static void RegisterPhysicsSystem(Action<double> system, int priority)
	{
		_physicsSystems.Add((system, priority));
		_physicsSystems = _physicsSystems.OrderByDescending(data => data.Item2).ToList();
	}
	...
	public static void PorcessAllPhysics(double delta)
	{
		foreach (var data in _physicsSystems)
		{
