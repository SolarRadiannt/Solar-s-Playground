...
public partial class Movement : Node, ISystem
{
	...
	{
		toMoveTo.For(HandleMoveTo);
		toApplyVel.For(ApplyMoveVelocity);
	}
	...
	private static void ApplyMoveVelocity(ref MoveDirection moveDir, ref MoveSpeed speed, ref MoveVelocity moveVel) =>
	...
	private static void HandleMoveTo(in Entity entity, ref EcsCharBody2D body, ref MoveDirection moveDir, ref MoveToGoal moveGoal)
	{
